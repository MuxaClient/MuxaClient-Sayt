  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#1a1a2e]">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/50 to-[#1a1a2e]/80" />
  ...
  if (selectedPlan) {
    return (
      <div className="min-h-screen relative overflow-hidden bg-[#1a1a2e]">
        <div
          className="fixed inset-0 bg-cover bg-center scale-100"
          style={{ backgroundImage: `url('${BASE}landing_1.jpg')`, backgroundSize: 'cover', imageRendering: 'auto' }}
        />
      <div className="fixed inset-0 bg-gradient-to-b from-black/70 via-black/50 to-[#1a1a2e]/80" />
